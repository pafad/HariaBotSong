...
bot.on('message',function (message) {
  if (message.content === 'h$join') {
   mes.channel.send({embed: { color: 0xFF0000,title:'Tu veux invité le bot pas de problème il est heberger H24: (https://discordapp.com/oauth2/authorize?client_id=329551988222066689&scope=bot&permissions=2146958591%27%7D%7D)%27%7D%7D)
  }
});
