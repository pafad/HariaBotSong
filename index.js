...
/*bot.on('message', function (message) { 
if (message.content.startsWith('h$annonce')&&( message.author.id =='300896265078571009'|| message.author.id =='283144121718276096'|| message.author.id =='307588259968581634') ) {
